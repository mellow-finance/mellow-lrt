...
contract Deploy is Script, DeployScript, Validator, EventValidator {
    function run() external {
        ...
        curators[0] = DeployConstants.ETHENA_CURATOR_MEV;
        curators[1] = DeployConstants.ETHENA_CURATOR_RE7;
        curators[2] = DeployConstants.ETHENA_CURATOR_NEXO;

        string[] memory names = new string[](n);
        names[0] = DeployConstants.ENA_VAULT_NAME;
        names[1] = DeployConstants.SUSDE_VAULT_NAME;

        string[] memory symbols = new string[](n);
        symbols[0] = DeployConstants.ENA_VAULT_SYMBOL;
        symbols[1] = DeployConstants.SUSDE_VAULT_SYMBOL;

        address[] memory underlyingTokens = new address[](n);
        underlyingTokens[0] = DeployConstants.ENA;
        underlyingTokens[1] = DeployConstants.SUSDE;

        address[] memory bonds = new address[](n);
        bonds[0] = DeployConstants.ENA_DEFAULT_BOND;
        bonds[1] = DeployConstants.SUSDE_DEFAULT_BOND;
        ...
        DeployInterfaces.DeployParameters memory deployParams = DeployInterfaces
            .DeployParameters({
                ...
                proxyAdmin: DeployConstants.MELLOW_ETHENA_PROXY_MULTISIG,
                admin: DeployConstants.MELLOW_ETHENA_MULTISIG,
                curators: curators,
                lpTokenName: "",
                lpTokenSymbol: "",
                ...
                initialDeposit: 0,
                initializer: Initializer(0x39c62c6308BeD7B0832CAfc2BeA0C0eDC7f2060c),
                initialImplementation: Vault(payable(0xaf108ae0AD8700ac41346aCb620e828c03BB8848)),
                erc20TvlModule: ERC20TvlModule(0x1EB0e946D7d757d7b085b779a146427e40ABBCf8),
                defaultBondTvlModule: DefaultBondTvlModule(0x1E1d1eD64e4F5119F60BF38B322Da7ea5A395429),
                defaultBondModule: DefaultBondModule(0xD8619769fed318714d362BfF01CA98ac938Bdf9b),
                ratiosOracle: ManagedRatiosOracle(0x955Ff4Cc738cDC009d2903196d1c94C8Cfb4D55d),
                priceOracle: ChainlinkOracle(0x1Dc89c28e59d142688D65Bd7b22C4Fd40C2cC06d),
                constantAggregatorV3: IAggregatorV3(0x6A8d8033de46c68956CCeBA28Ba1766437FF840F),
                defaultProxyImplementation: DefaultProxyImplementation(0x02BB349832c58E892a20178b9696e2b93A3a9b0f)
            });
