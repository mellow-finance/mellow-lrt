    ...
    */
    function validateParameters(
        ...
        if (validationFlags & 2 == 0) {
            ...
            require(
                setup.vault.totalSupply() == deployParams.initialDeposit * DeployConstants.INITIAL_DEPOSIT_MULITPLIER,
        ...
        // Vault values
        {
...

            {
                ...
                if (validationFlags & 2 == 0) {
                    require(
                        stack.totalSupply == deployParams.initialDeposit * DeployConstants.INITIAL_DEPOSIT_MULITPLIER,
                        "Invalid total supply"
                    );
                    require(
